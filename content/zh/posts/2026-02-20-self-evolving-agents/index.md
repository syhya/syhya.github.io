...
与此同时，DeepMind 在 **Accelerating Scientific Research with Gemini**（[Woodruff et al., 2026](https://arxiv.org/abs/2602.03837)）中呈现了前沿 LLM 作为“研究合作者”进入理论研究流程的实践，覆盖数学、理论计算机科学、物理与经济学等方向。模型已深度参与假设构建、路径搜索、证明生成与严谨性检验等核心科研环节。
